...
namespace AdventCalendar.Console.Configurations
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddQuestions(this IServiceCollection services)
        {
            ...
            services.AddTransient<IStringMapper<MoveCommand>, StringToMoveCommandMapper>();
            services.AddTransient<IStringToCrateMapper, StringToCrateStackCollectionMapper>();
            ...
            services.AddTransient<IDependendFileReader<CrateInstructionDto>, CrateAndCommandFileReader>();

            services.AddTransient<ICraneLogicFactory, CraneLogicFactory>();
            ...
            services.AddTransient<IAdventQuestion, AdventQuestionFive>();
